...
# message = Mail(
#     from_email='yvestutorialsnotifyme@gmail.com',
#     to_emails='niyoeri6@gmail.com',
#     subject='Sending with Twilio SendGrid is Fun',
#     html_content='<strong>and easy to do anywhere, even with Python</strong>')
# try:
#     sg = SendGridAPIClient(os.environ.get('ETBH.kigali.dev'))
...
def all_users_emails_week():
    weekly = ['byives21@gmail.com','niyoeri6@gmail.com']
...
def mailweek(*args, **kwargs):
    subject = "Report Remainder for reporting @@@@@@@@@@@@@@@@@@@@"
    message = "Dear, " \
              "Sir/Madam we just wanted to remind you about submitting reports.' \
              'Don't forget to submit on time " \
              "Thank you!!!"
    send_mail(subject, message, EMAIL_HOST_USER, ['niyoeri6@gmail.com','byiringiroyves127@gmail.com'])
...
def start(deadline):
    ...
    for simple in reports:
        if simple.igihe_itangirwa == 1:
            ...
            scheduler.add_job(mailweek, 'interval', days=2)
